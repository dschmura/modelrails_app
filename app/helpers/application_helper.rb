module ApplicationHelper
    ...
    def tailwind_classes_for(flash_type)
      {
        notice: "bg-green-600 border-l-4 border-green-700 text-green-50 ",
        error:   "bg-red-800 border-l-4 border-red-900 text-red-50",
        alert:   "bg-red-800 border-l-4 border-red-900 text-red-50",
